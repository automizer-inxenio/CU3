...
async def async_setup_entry(hass,entry):
	...
	try:
		with open(F,'r')as R:G=yaml.safe_load(R)
	...
	for E in P:
		...
		I=Q.match(E)
		if I:
			_LOGGER.info(f"READ EXPORT LINE: {E}");S=I.group('deviceName');B=I.group('deviceId');D=C.data[CONF_CU_NAME]+'_'+S
